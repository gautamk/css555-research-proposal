...
My research into Sotware maintainability would be focussed on evaluating existing  software models and architectures using commonly used metrics such as HPMAS described in the paper \say{Using Metrics to Evaluate Software System Maintainability}\cite{coleman_using_1994}
